...
client = MongoClient('mongodb+srv://produtkey:sKQpJFDqBzce0KBP@cluster0.ez0jfas.mongodb.net/')
db = client.thegodbypasser
collection = db.thegodbypasser
...
def register():
	...
	new_user = {
		...
		"settings": {
			...
			"proxy": "",
			"logs": [
				"blue:blue:Welcome to Thegodbypasser!"
			]
		},
		"role": "stable",
		"invites": {}
